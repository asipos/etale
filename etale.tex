\documentclass[13pt,openany,oneside]{book}
...
Al treilea capitol enunță propriu-zis conjecturile Weil, le reformulează pentru a se vedea analogia cu ipoteza lui Riemann, arată cum primele două sunt aproximativ o aplicație imediată a existenței teoriei coomologiei $\ell$-adice și indică ce anume mai este de arătat pentru a se desăvârși demonstrația.
...
Doresc să îi mulțumesc coordonatorului lucrării, domnul Victor Vuletescu, pentru discuțiile pe care le-am purtat de-a lungul (și datorită) acestei poate prea scurte colaborări.
...
Se observă că dacă $X_0$ este curbă eliptică se reconstituie relația de mai devreme, cu $b_1=2=dim\ H^1(\mathbb{C}/\Lambda, \mathbb{Q})$ (pentru $\Lambda$ o latice în planul complex).
...
Deci $H^d(\widetilde{X},\Qell)$ admite o filtrare cu spațiile cât $\{E_\infty^{p.q}\}_{p+q=d}$, care la rândul lor sunt subcâturi ale $E_2^{p,q}$-uri, ca urmare e suficient să arăt pentru acestea din urmă. Dintr-o teoremă de anulare, ele sunt nenule doar pentru $p$ între $0$ și $2$.
