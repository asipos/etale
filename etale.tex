...
Fixând $n$, notez $P_n$ polinomul minimal al lui $\lambda'^n$ peste $\mathbb{Q}_\ell$. Mulțimea $Z'_n=\{\alpha\in Sp(V,\psi)\mid \lambda'^n \in Spec(\alpha)\}$ este algebrică, deci de măsură Haar nulă. În final, putem zice:
